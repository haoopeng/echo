var textSet = {
    ...
    "bulgarian": {
        "Language": "Български",
        "Title": "ЕхоДемо",
        "Theme": "Как социалните медии допринасят за образуването на ехо стаи",
        "Scenario": "Сценарий",
        "Default": "По подразбиране",
        "AdvancedParameters": "Конфигурация за напреднали",
        "Tolerance": "Толерантност",
        "ToleranceDiscription": "Параметърът \"толерантност\" определя как агентите се справят с мнения различни от тяхното. Съобщенията, отразяващи мнения подобни на собстевното мнение на агента, се считат за съгласуващи се, в противен случай като противоречащи. Съгласуващите се съобщения могат да повлияят на собственото мнение на агента. Освен това, агентът понякога ще разприятели участник, публикуващ много противоречащи съобщения.",
        "Low": "Ниска",
        "Medium": "Средна",
        "High": "Висока",
        "Influence": "Влияние",
        "InfluenceDiscription": "Мнението на агента се актуализира и става по-сходно с тези, отразени в съгласувани съобщения от неговите приятели. Параметърът \"влияние\" контролира колко бързо се случва това.",
        "Off": "Без",
        "Weak": "Слабо",
        "Strong": "Силно",
        "Unfriending": "Разприятеляване",
        "UnfriendingDiscription": "Този параметър регулира колко често агентът премахва приятелството на друг агент, който публикува противоречащи съобщения, и го заменя с произволно избран нов агент.\n",
        "Never": "Никога",
        "Sometimes": "Понякога",
        "Often": "Често",
        "Progressive": "Прогресивно",
        "Conservative": "Консервативно",
        "LessPopular": "По-популярен",
        "MorePopular": "По-малко популярен",
        "Start": "Старт",
        "Stop": "Стоп",
        "Reset": "Нулиране",
        "Speed": "Скорост",
        "GraphTitle": "Мнения",
        "GraphDiscription": "Тази графика проследява как мненията на агентите се променят с течение на времето. Конвергенцията към няколко групи хомогенни мнения показва ефекта на ехо стая.",
        "Time": "Време",
        "ParameterSetting": "Настройка на параметрите",
        "Scenario01Discription": "Без влияние и разприятеляване, агентите са изложени на различни мнения, но техните собствени мнения не се променят. Основната структура на мрежата остава същата.",
        "Scenario02Discription": "Без разприятеляване, мрежовата структура остава непроменена и агентите са изложени на различни мнения. Въпреки това влиянието кара мненията на агентите да се променят. В зависимост от първоначалните условия и толерантността, мрежата се сближава или до хомогенно състояние, където всички (или почти всички) агенти имат умерено мнение, или до състояние, при което съществуват две (или повече) различни мнения.",
        "Scenario03Discription": "Без влияние, мненията не се променят. Процесът на премахване на приятелството обаче позволява на агентите бавно да се сортират в няколко хомогенни групи.",
        "Scenario04Discription": "Когато агентите са повлияни от своите приятели с мнения подобни на тяхното и могат да разприятеляват тези с различни мнения, мрежата бързо се слива в две или повече сегрегирани и хомогенни ехо стаи. Броят зависи от толерантността, стига да не е твърде висока: колкото по-малка е толерантността, толкова повече ехо стаи се образуват.",
        "Scenario05Discription": "При висока толерантност, премахването на приятелството има малък ефект. Влиянието кара системата бързо да се сближи в една група с хомогенни мнения.",
        "PostMessage": "Потребител [t_node.name] написа ново съобщение.",
        "RepostMessage": "Потребител [t_node.name] сподели съобщението на потребител [repost_node.name].",
        "ReadMessage": "Потребител [t_node.name] прочете [concordant_nodes.length] съобщения.",
        "BecomeMoreProgressice": "Потребител [t_node.name] стана малко по-прогресивен.",
        "BecomeLessProgressice": "Потребител [t_node.name] стана малко по-малко прогресивен.",
        "BecomeLessConservative": "Потребител [t_node.name] стана малко по-малко консервативен.",
        "BecomeMoreConservative": "Потребител [t_node.name] стана малко по-консервативен.",
        "Unfollow": "Потребител [t_node.name] разприятели потребител [del_node.name] и стана приятел с потребител [add_node.name].",
        "TranslatersName": "Превод на бълграски <a href='https://data-for-good.bg/authors/nikola-tulechki/'>Никола Тулечки</a>",
        "InfoTitle": "Eхо Демо: FAQ",
        "InfoIntroQ": "Какво е Ехо Демо?",
        "InfoIntroA": "EchoDemo е математическа симулация, която демонстрира как два основни механизма на социалните медии --- повлияване от мненията на приятелите и премахване на приятели с различни мнения --- могат да доведат до поляризирани и сегрегрегирани социални мрежи. За повече подробности вижте нашата <a href='https://arxiv.org/abs/1905.03919'>публикация</a>.",
        "InfoRepresentQ": "Какво представлява мрежата?",
        "InfoRepresentA": "Всеки възел в мрежата представлява потребител; неговият размер представлява неговата популярност (брой приятели), а цветът му представлява неговото политическо мнение. Приятелските връзки се приемат за взаимни.",
        "InfoHowQ": "Как работи?",
        "InfoHowA": "Потребителите правят четири неща: (1) четат съобщения, публикувани или споделени от тяхните приятели; (2) променят малко мнението си (в зависимост от параметъра \"влияние\") според съгласуващите съобщения (въз основа на параметъра \"толерантност\"); (3) от време на време (въз основа на параметъра \"разприятеляване\")\nте заместват приятел, който публикува съобщения, достатъчно различни от\nсобственото им мнение (въз основа на параметъра \"толерантност\") със случаен\nприятел; и (4) те или публикуват ново съобщение, отразяващо тяхното\nмнение или споделят някое съгласуващо съобщение (въз основа на параметъра \"толерантност\"\n) от случаен приятел.",
        "InfoInstructionsQ": "Какво мога да правя?",
        "InfoInstructionsA": "Първоначално потребителите имат различни произволни мнения и са свързани в произволна мрежа. Опитайте различни стойности на параметрите (или изберете един от сценариите), стартирайте симулацията и наблюдавайте какво се случва. Как се променят мненията на потребителите и как това влияе върху мрежовата структура?"
    }
}